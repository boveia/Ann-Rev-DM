...
Those choices ensure that the model is still perturbative in most of the parameter space
...
an appreciable cross section. Many such models have been proposed. For example, DM can interact with the Standard Model via a dark
...
%add cite for freeze-in models, add sentence from Felix
...
feebly with the Standard Model is a theory of DM. Drawing the connections
...
the Standard Model prediction if the \textit{Z} boson were coupled to additional {\IP}s
...
compared with Standard Model predictions to search for new processes }
