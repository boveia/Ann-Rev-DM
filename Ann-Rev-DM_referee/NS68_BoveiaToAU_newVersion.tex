...
DM may not be composed of particles at all, but of the Standard Model of particle physics (SM)
in describing ordinary matter gives us a strong reason to consider a particle description of dark matter as well. 

Neverthless, the evidence for DM, described in e.g. Reference~\cite{Bertone:2004pz}, is inconsistent with the properties of any known 
particle. While DM has gravitational interactions with normal matter, DM particles are {\it dark}---see the Sidebar---its non-gravitational
interactions must be relatively rare. DM is very stable, with a lifetime comparable to that of the Universe (e.g. Reference~\cite{Cohen:2016uyg}).
It is also non-relativistic and collisionless. But most striking is its abundance, derived from measurements of the cosmic microwave background~\cite{Ade:2015xua}.
There is about five times as much DM as the matter described by the Standard Model. 
This fact provides one of the few quantitative clues about BSM physics, and suggests that 
the DM particle sector could match or exceed the complexity of ordinary matter.
...
Particle physicists are increasingly keen to understand what DM is, if it is indeed a particle. 
Some experimenters, working at \MakeLowercase{Direct Detection} (DD) experiments, look for galactic DM
colliding with underground targets made of standard matter~\cite{0954-3899-43-1-013001}.
...
in DD searches, DM annihilation to SM particles in ID searches. 

Colliders, among the most successful tools of particle physics, have revealed much about ordinary matter.  
If DM can be produced at colliders, they will likely remain one of our choice tools for learning more about it,
...
colliding SM particles and the DM particles.
If we can produce dark matter at the LHC or its successors, we might begin to comprehend the forces that connect 
ordinary matter to dark matter, and to understand how the two interacted
...
collider currently in operation, the Large Hadron Collider (LHC) at CERN.
