...
Moreover, the sensitivity hierarchy of \MET+X searches does not privilege the jet+\MET final state if there is a direct new physics coupling between the vector boson and the DM, as in the case of the EFT model mentioned in Section~\ref{sub:EFT}.
...
The main backgrounds for the photon+\MET search and for the leptonic decays of the 

The estimation of these backgrounds mirrors that of the jet+\MET search, where \MET is emulated by removing visible Z boson decays from the event transverse momentum balance in control regions, and transferring the number of measured events to the signal region. In these cases, the W control region is not used. 
%The CMS photon+\MET search uses MC simulation. 


involve decays of Z to neutrinos, where a photon or an additional vector boson are radiated. 

For this, and for the main 

The background estimation technique for the main $\gamma$/V+\MET search 


Another approach is to follow a mono-Higgs event selection and reinterpret the results. 


The main experimental uncertainties for V+\MET searches
and the sensitivity to specific 

Searches in the \MET+leptonic Z final state provide constraints on 
\mmed $<$ 650 GeV for vector and axial vector mediators,
while they are not yet sensitive to scalar and pseudoscalar mediated models. %CMS 

Talk about t-channel and radiation. 

Hadronic decays of the Z constrain 

Leptonic decays W bosons have also been used in the past for this kind of searches, but due to the additional experimental challenges (invisible decays)
...
%Sidebar (50 words minimum, 200 words maximum) briefly discussing a fascinating adjacent topic; insert below Literature Cited section, but indicate near which section in text the sidebar should be typeset
\begin{textbox}[!h]
\section{Triggering for visible and invisible searches}
This is why this is important, this is 10 words. 
This is why this is important, this is 10 words. 
This is why this is important, this is 10 words. 
This is why this is important, this is 10 words. 
