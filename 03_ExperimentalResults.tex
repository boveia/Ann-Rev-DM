...
(e.g. the mediator is produced in association with two heavy flavor quark) is exploited in 
the search strategy. Signatures including \MET and two heavy flavor quarks are similar to 
signatures of third generation quark superpartners, in some cases leading to those searches being
performed 
%conducted? bleurgh
together.  

Other searches in this category are those only searching for only one top or bottom quark
(also called mono-top or mono-bottom searches). The main background for these searches are 
single top or misidentified $t\bar{t}$ processes. 
