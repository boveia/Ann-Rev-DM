...
While collider experiments alone cannot discover DM, they can discover invisible particles, and this could open up direct study of DM--SM mediators in other channels and of additional particles in a dark sector. %this essentially means we are free from astroparticle uncertainties, more explicit?
...
Below we discuss experimental searches for invisible particles from three LHC~\cite{LHC2008} experiments, ATLAS, CMS, and LHCb~\cite{ATLAS2008,CMS2008,LHCb2008} and briefly touch on some results from previous colliders. %does ALICE search for invisible particles?
