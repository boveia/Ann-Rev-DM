...
As an example, we again consider the case of (axial-)vector mediators, to which both jet+\MET and two-body resonance searches are sensitive.
Though the model is simple, its parameter space is four-dimensional (two couplings, the \IP mass, and the mediator mass).
...
Figure~\label{fig:sensitivityComparison} shows a recent ATLAS plot.
