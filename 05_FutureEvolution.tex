...
%  The extrapolation of these results to other types of experiments should also take tbe more rigorously  stem from the matrix elements of the nuclei, but this is an uncertainty that affects DD as well. %Could make this clearer and cite? 
