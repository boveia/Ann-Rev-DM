...
\begin{marginnote}[]
\entry{The ATLAS/CMS Dark Matter Forum}{provided reference implementations of the models in Ref.~\cite{Abercrombie:2015wmb} at \url{https://gitlab.cern.ch/lhc-dmwg-material/model-repository}} and are implemented in models for various event generators (e.g. DMSimp~\cite{Backovic:2015soa}). 
\end{marginnote}
