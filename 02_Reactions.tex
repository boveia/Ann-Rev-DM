...
interaction details are conveniently integrated out. This can encompass cases where new particles are much heavier than the SM bosons that mediate the interaction. In this case, we describe the collider production of invisible particles through \textbf{Effective Field Theories (EFTs)}~\cite{Goodman:2010ku, Shoemaker:2011vi}. 
...
In this case, we assume that only a small number of new particles are going to be important for the collider phenomenology and develop simplified models to describe these. Along
...
\begin{marginnote}[]
\entry{The Dark Matter Forum}{forum for DM at the LHC that was created following the discussion in various communities, see Refs.~\cite{Yavin:14092893,Malik:2014ggr,Abdallah:2015ter}. All models covered in~\cite{Abercrombie:2015wmb} are available on the DMF git repository. Add reference.} 
\end{marginnote}
