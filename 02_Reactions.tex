...
LHC signatures feature missing transverse momentum from the neutralino and a multiplicity of other objects
(leptons, jets) produced from the cascade decays of heavier supersymmetric objects. If the
next-to-lightest SUSY particle (NLSP) is much heavier than the LSP, the LSP will be boosted and produce
...
%MSUGRA: gravitino is too weakly interacting?
a 3/2-spin particle superpartner of the graviton. 

The gravitino can be a LSP in GSMB theories, with masses between the eV and the keV. 
READ COVI
...
%Relic connection
There is a large possible dark boson and DM candidate mass range that is compatible with thermal freeze-out~\cite{Das:2010ts}. Another mechanism for generating the relic density that is consistent with very weak SM interactions such as those of dark photons is the freeze-in scenario (see e.g.~\cite{Co:2015pka,Bernal:2017kxu}), where
