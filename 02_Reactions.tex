...
The use of DM observations as the guiding principle for reactions of DM at colliders 
still leads to a nearly unlimited choice of theoretically
motivated search targets. 

Theoretical arguments alone are not sufficient
for a DM model to be tested at the LHC: 
...
The only SM particle that satisfies the requirement of being sufficiently weakly interacting is the neutrino.
