...
In the following we enumerate the possible reactions of DM at the LHC within these grounding assumptions. We start from models that do not add any other particle to the SM except to the DM and continue to models with more complex particle content and interaction. 
