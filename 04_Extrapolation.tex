...
\begin{marginnote}[]
\entry{The LHC Dark Matter Working Group}{provides  for the translation of LHC limits to DD and ID in~\cite{Boveia:2016mrp}, as well as calculations of relic density at~\url{https://gitlab.cern.ch/lhc-dmwg-material/relic-density}.} 
\end{marginnote}
