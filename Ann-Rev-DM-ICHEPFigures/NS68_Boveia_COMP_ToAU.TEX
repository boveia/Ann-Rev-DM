...
approaching $\sim$2 TeV for neutralino masses up to 1 TeV, as shown in Figure~\ref{fig:SUSYSummary_ew}
...
DM. Abbreviations:\ DM, dark matter; ISR, initial-state radiation; TLA, trigger-object level analysis. Adapted from~Reference \citen{ATLASSummary}.}
