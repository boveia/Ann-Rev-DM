...
interactions must be relatively rare. DM is very stable, with a lifetime comparable to that of the Universe (e.g. Reference~\citen{Cohen:2016uyg}).
...
\begin{figure}[!htpb]
\includegraphics[width=0.7\textwidth]{figures/FakeMET}
...
Photon+\MET searches~\cite{Aaboud:2017dor,CMS-PAS-EXO-16-014} has lower backgrounds
...
model (outlined in Section~\ref{sub:simplifiedModels} and shown in Figure~\ref{fig:feynman_1}\textit{c})
with \gq = 1, \gdm = 1, and \ghZprimeZprime/$m_{Z}$ = 1, and on a
\Zprime--2HDM (Figure~\ref{fig:feynman_1}\textit{d}).
...
constraints on them are significantly weaker, as shown in Figure~\ref{fig:SUSYSummary_cms_ew}. Third-generation
...
\caption{Mass reach of ATLAS searches for a selection of
results targeting electroweak supersymmetry production, available as of
December 2017~\cite{ATLASSUSYSummary}.\label{fig:SUSYSummary_atlas_ew}}
\end{figure}

\begin{figure}[!htpb]
\includegraphics[width=\textwidth]{figures/CMS-SUS-17-004_Figure_010-a.pdf}
\caption{Mass reach of CMS searches for a selection of
results targeting electroweak supersymmetry production, available as of
December 2017~\cite{CMSSUSYSummary}.\label{fig:SUSYSummary_cms_ew}}
\end{figure}

Although LHC searches have so far probed mainly  SUSY channels that are strongly
produced, searches for more rare processes are now entering their prime. With the data now collected, one can explore the
...
difference as low as 0.2 GeV for higgsino models~\cite{ATL-PHYS-PUB-2017-019}, in Fig.\ref{fig:SUSYSummary_atlas_ew}. Other mechanisms of decay
...
15\% (roughly \gq $>$ 0.5). Abbreviation:\ DM, dark matter.
Pre-LHC constraints are from Reference \citen{Dobrescu:2013coa}.}\label{fig:couplingmass}
\end{figure}
...
\begin{figure}[!htpb]
\includegraphics[width=0.8\textwidth]{figures/ATLAS_DarkMatter_Summary_Vector.pdf}\\
\includegraphics[width=0.8\textwidth]{figures/ATLAS_DarkMatter_Summary_Vector_ModifiedCoupling.pdf}
...
Mastercode Collab. arXiv:1710.11091 [hep-ph] (2017)
...
%  [arXiv:1503.05505 [hep-ph]].
  %%CITATION = doi:10.1007/JHEP11(2015)108;%%
  %11 citations counted in INSPIRE as of 18 Oct 2018
